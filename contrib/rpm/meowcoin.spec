...
License:	MIT
URL:		https://slmecrypto.com/
Source0:	https://slmecrypto.com/bin/slimecoin-core-%{version}/slimecoin-%{version}.tar.gz
...
%{_sbindir}/semanage port -a -t slimecoin_port_t -p tcp 9766
%{_sbindir}/semanage port -a -t slimecoin_port_t -p tcp 8788
%{_sbindir}/semanage port -a -t slimecoin_port_t -p tcp 18766
