...
reference the release tarball available from https://slmecrypto.com/bin/ and
`Source1` should reference the BerkeleyDB source.

Sources 10-99 are for source files that are maintained in the
[Slimecoin git repository](https://github.com/JustAResearcher/Slimecoin) but are not part of
