...
UniValue createrawtransaction(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "Outputs are addresses (paired with a SLME amount, data or object specifying an asset operation) or data.\n"
            "Returns hex-encoded raw transaction.\n"
            "Note that the transaction's inputs are not signed, and\n"
            "it is not stored in the wallet or transmitted to the network.\n"

            "\nPaying for Asset Operations:\n"
            "  Some operations require an amount of SLME to be sent to a burn address:\n"
            "\n"
            ...
            "         x.xxx                             (number or string, required) The SLME amount\n"
            "           or\n"
            ...
            // TODO if we decide to remove the consensus check from issue 675 https://github.com/JustAResearcher/Slimecoin/issues/675
...
// TODO, if we decide to remove the consensus check https://github.com/JustAResearcher/Slimecoin/issues/675, remove or add the code (requires consensus change)
