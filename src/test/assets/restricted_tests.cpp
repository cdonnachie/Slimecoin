...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler slme tx
        CScript slmeTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut slmeOut(1*COIN, slmeTransfer);
        ...
        mutTxTest1.vout.emplace_back(slmeOut);
        ...
        mutTxTest2.vout.emplace_back(slmeOut);
        ...
        mutTxTest3.vout.emplace_back(slmeOut);
        ...
        mutTxTest4.vout.emplace_back(slmeOut);
        ...
        mutTxTest5.vout.emplace_back(slmeOut);
        ...
        mutTxTest6.vout.emplace_back(slmeOut);
        ...
        mutTxTest7.vout.emplace_back(slmeOut);
        ...
        mutTxTest8.vout.emplace_back(slmeOut);
