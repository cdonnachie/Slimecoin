...
class TxnMallTest(SlimecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 SLME:
        ...
        # First: use raw transaction API to send 1240 SLME to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SLME coin each
        ...
        # Node0's balance should be starting balance, plus 50SLME for another
        ...
        # Node0's total balance should be starting balance, plus 100SLME for 
