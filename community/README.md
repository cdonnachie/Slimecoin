...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like slimecoind does for SLME)
...
* Run a contest: SLME prize for best idea for new Slimecoin based Business
...
* Fee system to pay SLME fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of SLME for fees.
...
* Collaborate with hardware wallets for additional SLME and asset support
